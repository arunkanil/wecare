		...
		<div class="menu trans_500">
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					...
					<li class="menu_item"><a href="services.html">Departments</a></li>
					<li class="menu_item"><a href="doctors.html">Doctors</a></li>
					<li class="menu_item"><a href="appointments.html">Appointments</a></li>
					<li class="menu_item"><a href="insurance.html">Insurance</a></li>
					<li class="menu_item"><a href="news.html">News</a></li>
					<li class="menu_item"><a href="promotions.html">Offers</a></li>
			...
			<div class="menu_social">
				<ul>
					...
					<li><a href="#"><i class="fa fa-facebook" style="font-size: 25px;" aria-hidden="true"></i></a></li>
									...
									<div
										...
										<div
											...
											<div class="header_top_phone">
												...
												<a target="_blank" href="https://wa.me/+971544826861?text=I'm%20interested%20in%20getting%20an%20appointment%20at%20WeCare."><span>+971-544826861</span></a>
												<i class="fa fa-phone ml-4" aria-hidden="true"></i>
												<a href="tel:+971-501224907"><span>+971-501224907</span></a>
											</div>
										</div>
					...
					<div class="col-lg-8 contact_col">
						<div class="contact_form">
							...
							<div class="contact_form_container">
								<form id="contact_form" action="contact_submit.php" class="contact_form">
									<input type="text" id="contact_name" name="contact_name" class="contact_input"
										placeholder="Your Name" required="required">
									<input type="email" id="contact_email" name="contact_email" class="contact_input"
										placeholder="Your E-mail" required="required">
									<input type="number" id="contact_number" name="contact_number" class="contact_input"
										placeholder="Your Phone" required="required">
									<select id="contact_type" name="contact_type" class="contact_input mb-4">
										<option value="corporate">Corporate</option>
										<option value="personal">Personal</option>
									</select>
									<input type="text" id="contact_subject" name="contact_subject" class="contact_input"
										placeholder="Subject" required="required">
									<textarea class="contact_input contact_textarea" id="contact_message"
										name="contact_message" placeholder="Message" required="required"></textarea>
									<button type="submit" class="contact_button" id="contact_button">send
										message</button>
								</form>
							</div>
						</div>
					...
					<div class="col-lg-4 contact_col">
						<!-- <div class="info_form_container">
							...
							<form action="#" class="info_form" id="info_form">
								...
								<input type="email" class="info_input" required placeholder="E-mail">
								<input type="number" class="info_input" required placeholder="Phone No">
						...
						<div class="row">
							<div class="col-lg-4 offset-lg-1">
								<div class="contact_info_list">
									...
									<ul>
										<li><span>Address: </span>P.O Box - 122542, Near Ansar Gallery, Hamsah A
											Building, Khalid bin Al Waleed Road, Al Karama, Dubai - UAE</li>
										<li><span>Email: </span>info@wecaremedicalcenter.ae</li>
										<li>
											<span>Phone: </span><a href="tel:+971-544826861"><span>+971-544826861</span></a>
											<span>  , </span>
											<a href="tel:+971-2611061"><span>+971-2611061</span></a>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="contact_info_list">
									...
									<ul>
										<li class="d-flex flex-row align-items-center justify-content-start">
											...
											<div class="ml-auto">8.00 AM – 9.00 PM</div>
										</li>
										<li class="d-flex flex-row align-items-center justify-content-start">
											<div>Friday</div>
											<div class="ml-auto">8.00 AM - 12.30 PM</div>
										</li>
										<li class="d-flex flex-row align-items-center justify-content-start">
											<div></div>
											<div class="ml-auto">5.00 PM – 09.00 PM</div>
										</li>
									</ul>
								</div>
							</div>
			...
			<div class="footer_content">
				<div class="container">
					<div class="row">
						...
						<!-- Footer Hours -->
						<div class="col-lg-4 footer_col"  style="margin-top: 40px;">
